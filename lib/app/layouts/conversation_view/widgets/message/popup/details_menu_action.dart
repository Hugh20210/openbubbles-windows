...
const Map<DetailsMenuAction, PlatformSupport> _actionPlatformSupport = {
  ...
  DetailsMenuAction.ReportIssue: PlatformSupport(true, true, true, true),
  DetailsMenuAction.UploadAttachment: PlatformSupport(true, true, true, true),
...
const Map<DetailsMenuAction, String> _actionToText = {
  ...
  DetailsMenuAction.ReportIssue: "Report Issue",
  DetailsMenuAction.UploadAttachment: "Upload Attachment to iCloud",
