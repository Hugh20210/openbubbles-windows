...
import 'package:openbubbles/app/layouts/conversation_list/dialogs/conversation_peek_view.dart';
...
import 'package:openbubbles/app/layouts/conversation_list/widgets/tile/pinned_tile_text_bubble.dart';
...
class PinnedIndicators extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return Obx(() {
      final showTypingIndicator = cvc(controller.chat).showTypingIndicatorFor.isNotEmpty;
