...
import 'package:openbubbles/app/layouts/conversation_list/widgets/tile/pinned_conversation_tile.dart';
import 'package:openbubbles/app/layouts/conversation_list/widgets/conversation_list_fab.dart';
import 'package:openbubbles/app/layouts/conversation_list/widgets/header/cupertino_header.dart';
...
class CupertinoConversationListState
    extends OptimizedState<CupertinoConversationList> {
                ...
                child: Obx(() => CustomScrollView(
                      ...
                      slivers: <Widget>[
                        ...
                        Obx(() {
                          ...
                          int rowCount = context.mediaQuery.orientation ==
                          ...
                          int usedRowCount =
                              min((pinCount / colCount).ceil(), rowCount);
                          ...
                          return SliverPadding(
                            ...
                            sliver: SliverToBoxAdapter(
                              child: LayoutBuilder(builder:
                                ...
                                double height = usedRowCount *
                                    (maxWidth * 1.15 +
                                        10 +
                                        style.height! * style.fontSize! * 2);
                                // avatar only
                                    ...
                                    children: [
                                      ListView.builder(
                                        ...
                                        findChildIndexCallback: (key) =>
                                            findChildIndexByKey(_chats, key,
                                                (item) => item.guid),
                          ...
                          child: Obx(() => Column(
                            children: [
                              ...
                              Container(
                                    ...
                                    child: Column(
                                      children: chats.suggestedHandles
                                          .map(
                                            (child) => InkWell(
                                              onTap: () {
                                                print("here");
                                                ns.pushAndRemoveUntil(
                                                  context,
                                                  ChatCreator(initialSelected: [SelectedContact(displayName: child.displayName, address: child.address, isIMessage: true)]),
                                                  (route) => route.isFirst,
                                                );
                                              },
                                              child: Container(
