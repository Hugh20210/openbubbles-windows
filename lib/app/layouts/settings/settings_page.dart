...
import 'package:openbubbles/app/layouts/settings/pages/advanced/notification_providers_panel.dart';
import 'package:openbubbles/app/layouts/settings/pages/advanced/tasker_panel.dart';
import 'package:openbubbles/app/layouts/settings/pages/profile/profile_panel.dart';
import 'package:openbubbles/app/layouts/settings/pages/scheduling/message_reminders_panel.dart';
import 'package:openbubbles/app/layouts/settings/pages/server/backup_restore_panel.dart';
import 'package:openbubbles/app/layouts/settings/pages/system/device_panel.dart';
...
import 'package:openbubbles/app/layouts/settings/pages/misc/about_panel.dart';
import 'package:openbubbles/app/layouts/settings/pages/message_view/attachment_panel.dart';
import 'package:openbubbles/app/layouts/settings/pages/conversation_list/chat_list_panel.dart';
import 'package:openbubbles/app/layouts/settings/pages/message_view/conversation_panel.dart';
import 'package:openbubbles/app/layouts/settings/pages/desktop/desktop_panel.dart';
import 'package:openbubbles/app/layouts/settings/pages/misc/misc_panel.dart';
import 'package:openbubbles/app/layouts/settings/pages/system/notification_panel.dart';
import 'package:openbubbles/app/layouts/settings/pages/advanced/private_api_panel.dart';
import 'package:openbubbles/app/layouts/settings/pages/advanced/redacted_mode_panel.dart';
import 'package:openbubbles/app/layouts/settings/pages/server/server_management_panel.dart';
import 'package:openbubbles/app/layouts/settings/pages/scheduling/scheduled_messages_panel.dart';
import 'package:openbubbles/app/layouts/setup/dialogs/proxy_settings_dialog.dart';
...
import 'package:openbubbles/app/layouts/settings/pages/theming/theming_panel.dart';
import 'package:openbubbles/app/layouts/settings/pages/misc/troubleshoot_panel.dart';
import 'package:openbubbles/app/wrappers/stateful_boilerplate.dart';
import 'package:openbubbles/app/wrappers/tablet_mode_wrapper.dart';
